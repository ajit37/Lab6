...
class Student:
    # Define the name and number when a student object is created(Changed self number value to str)
    def __init__(self, name, number):
        self.name = name
        # Ensure the student number is stored as a string for consistency
    ...
    # Calculate the grade point average of all courses and return a string(Added 0 if no courses)
    def displayGPA(self):
    ...
    # Return a list of courses that the student passed (grades > 0.0)(Change to return courses passed)
